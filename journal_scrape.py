...
class Database:
	def __init__(self):
		self.dbname = "findingsdb"
		# set up the Amazon RDS database here
		self.host = "findingsdb.c9zjgwsivgee.us-east-2.rds.amazonaws.com"
		self.port = 3306
...
class J_Neurophys:
	...
	def get_article(self, url):
		...
		fulltext = art_page.find('div', {'class': 'hlFld-Fulltext'}).findChildren(recursive=False)
		intro_flag = 1
		for f in fulltext:
